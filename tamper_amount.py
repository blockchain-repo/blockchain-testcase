...
def create_transfer():
    ...
    tx = Transaction.create([alice.public_key], [([alice.public_key], 1000)], metadata=metadata, asset=asset)
    print(" ")
    print("1.tx_create asset id    :  alice-----money 1000(", tx.to_dict()['transaction']['asset']['id'],
          ")----->alice")
    ...
    # transfer
    tx = Transaction.transfer([inputs], [([bob.public_key], 300), ([alice.public_key], 700)], asset)
    print("2.tx_transfer asset id    :  alice-----money 300(", tx.to_dict()['transaction']['asset']['id'], ")----->bob")
    ...
    print("3.tx_attack asset id    :  alice-----money 600(", tx.to_dict()['transaction']['asset']['id'], ")----->tom")
